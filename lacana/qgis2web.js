...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8188555.264020, 570803.236214, -8185117.748196, 574425.351619], maxZoom: 28, minZoom: 1
    })
});


    var searchLayer = new ol.SearchLayer({
      layer: lyr_puntosporpredio_7,
      colName: 'CEDULA CAT',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-8188555.264020, 570803.236214, -8185117.748196, 574425.351619], map.getSize());
